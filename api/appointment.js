...
const SMS_USER = process.env.SMS_USER || "ENTCARE_01";
const SMS_PASS = process.env.SMS_PASS || "123456";
const SMS_SENDER = process.env.SMS_SENDER || "BUZWAP";
...
// ---------------- API ----------------
app.post("/api/appointment", async (req, res) => {
  const { name, age, sex, phone, date, timeSlot, service } = req.body;
...
const waResponse = await axios.get(
  "http://bhashsms.com/api/sendmsgutil.php",
  {
    params: {
      ...
      sender: SMS_SENDER,
      phone: phone, // 91XXXXXXXXXX
      text: "new_entcare", // ✅ correct template name
      priority: "wa",
      stype: "normal",
      Params: `${name},Dr. Swati Kodur (Patil),${formattedDate},${service},${CLINIC_MAP_LINK},${timeSlot}`,
    },
  }
);
