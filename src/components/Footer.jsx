    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-12 pt-6 pb-8">
          ...
          {/* Bottom Section */}
<div className="pt-1 pb-2 sm:pb-1 md:pb-0.1  mx-2 sm:mx-6 lg:mx-16">
            ...
            {/* Copyright */}
            <div className="text-center  pt-1 mt-2 border-t border-white/10">
              <p className="text-xs sm:text-sm text-blue-100/80">
                © 2025 ENT Care Clinic. All rights reserved.
              </p>
            </div>
          </div>
        </div>
